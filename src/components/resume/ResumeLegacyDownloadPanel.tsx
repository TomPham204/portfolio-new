...
export default function ResumeLegacyDownloadPanel() {
	return (
		<div className="w-[13vw] h-fit p-3 cursor-default bg-[#e4e4e482] rounded-md border-2 border-[#5e2700] border-dashed flex flex-col gap-3 items-center font-['Handlee'] font-bold text-[1.4vw] absolute top-[9.5vw] right-[21vw] backdrop-blur-sm z-20">
			<a
