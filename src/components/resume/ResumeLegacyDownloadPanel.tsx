...
export default function ResumeLegacyDownloadPanel() {
	return (
		<div className="mx-auto mt-5 lg:mt-0 cursor-default flex justify-center items-center px-5 font-Handlee font-bold backdrop-blur-xs z-20 lg:absolute w-full lg:w-[10rem] xl:w-[14vw] text-lg xl:text-[1.4vw] lg:top-[9rem] lg:right-[15vw] xl:top-[10vw] xl:right-[20.5vw]">
